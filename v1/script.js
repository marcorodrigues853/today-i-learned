...
async function loadFacts() {
  const res = await fetch(
    'https://fcajkqpptvlwnvnubizh.supabase.co/rest/v1/facts',
    {
      headers: {
        apikey:
        ...
        authorization:
          'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZjYWprcXBwdHZsd252bnViaXpoIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzA4NTM4NjEsImV4cCI6MTk4NjQyOTg2MX0.nXyNoTBhR5ll6OmEaSgb6GGHdTW8_mpr0Mq0Ka9121k',
      },
    },
  );
